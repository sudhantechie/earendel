...
connection_close_counter = Counter(
    "earendel_replication_tcp_protocol_close_reason",
    "",
    labelnames=["reason_type", SERVER_NAME_LABEL],
)

tcp_inbound_commands_counter = Counter(
    "earendel_replication_tcp_protocol_inbound_commands",
...
tcp_outbound_commands_counter = Counter(
    "earendel_replication_tcp_protocol_outbound_commands",
...
pending_commands = LaterGauge(
    name="earendel_replication_tcp_protocol_pending_commands",
    desc="",
...
transport_send_buffer = LaterGauge(
    name="earendel_replication_tcp_protocol_transport_send_buffer",
    desc="",
    labelnames=["name", SERVER_NAME_LABEL],
)
...
tcp_transport_kernel_send_buffer = LaterGauge(
    name="earendel_replication_tcp_protocol_transport_kernel_send_buffer",
    desc="",
    labelnames=["name", SERVER_NAME_LABEL],
)
...
tcp_transport_kernel_read_buffer = LaterGauge(
    name="earendel_replication_tcp_protocol_transport_kernel_read_buffer",
    desc="",
    labelnames=["name", SERVER_NAME_LABEL],
)
