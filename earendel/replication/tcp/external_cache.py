...
class ExternalCache:
    ...
    async def set(self, cache_name: str, key: str, value: Any, expiry_ms: int) -> None:
        ...
        with opentracing.start_active_span(
            "ExternalCache.set",
            tags={opentracing.EarendelTags.CACHE_NAME: cache_name},
        ):
