...
class ReplicationRemoteJoinRestServlet(ReplicationEndpoint):
    ...
    async def _handle_request(  # type: ignore[override]
        self, request: EarendelRequest, content: JsonDict, room_id: str, user_id: str
    ) -> tuple[int, JsonDict]:
...
class ReplicationRemoteRejectInviteRestServlet(ReplicationEndpoint):
    ...
    async def _handle_request(  # type: ignore[override]
        self, request: EarendelRequest, content: JsonDict, invite_event_id: str
    ) -> tuple[int, JsonDict]:
...
class ReplicationRemoteRescindKnockRestServlet(ReplicationEndpoint):
    ...
    async def _handle_request(  # type: ignore[override]
        self, request: EarendelRequest, content: JsonDict, knock_event_id: str
    ) -> tuple[int, JsonDict]:
        txn_id = content["txn_id"]
        event_content = content["content"]
