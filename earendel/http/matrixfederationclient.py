...
import earendel.util.retryutils
...
from earendel.http.connectproxyclient import BearerProxyCredentials
from earendel.http.federation.matrix_federation_agent import MatrixFederationAgent
...
from earendel.util.async_helpers import AwakenableSleeper, Linearizer, timeout_deferred
...
outgoing_requests_counter = Counter(
    "earendel_http_matrixfederationclient_requests",
    "",
    labelnames=["method", SERVER_NAME_LABEL],
)
incoming_responses_counter = Counter(
    "earendel_http_matrixfederationclient_responses",
    "",
...
class MatrixFederationHttpClient:
    ...
    async def _send_request_with_optional_trailing_slash(
        ...
        **send_request_args: Any,
        ...
        'M_UNRECOGNIZED' errcode. This is a workaround for Earendel <= v0.99.3
        due to https://github.com/sudhantechie/earendel/issues/3622.
        ...
        try:
            ...
            if e.code != 400 or e.to_earendel_error().errcode != "M_UNRECOGNIZED":
                raise

            # Retry with a trailing slash if we received a 400 with
            # 'M_UNRECOGNIZED' which some endpoints can return when omitting a
            # trailing slash on Earendel <= v0.99.3.
    ...
    async def _send_request(
        ...
        Args:
            ...
            long_retries: whether to use the long retry algorithm.
                ...
                https://github.com/sudhantechie/earendel/issues/8917
        ...
        limiter = await earendel.util.retryutils.get_retry_limiter(
    ...
    async def put_json(
        ...
        Args:
            ...
            try_trailing_slash_on_400: True if on a 400 M_UNRECOGNIZED
                ...
                of the request. Workaround for https://github.com/sudhantechie/earendel/issues/3622
                in Earendel <= v0.99.3. This will be attempted before backing off if
    ...
    async def get_json(
        ...
        Args:
            ...
            try_trailing_slash_on_400: True if on a 400 M_UNRECOGNIZED
                ...
                the request. Workaround for https://github.com/sudhantechie/earendel/issues/3622
                in Earendel <= v0.99.3.
    ...
    async def get_file(
        ...
        Raises:
            ...
            RequestSendFailed: If there were problems connecting to the
                remote, due to e.g. DNS failures, connection timeouts etc.
            EarendelError: If the requested file exceeds ratelimits
        """
        request = MatrixFederationRequest(
            method="GET", destination=destination, path=path, query=args
        )
        ...
        if not send_req:
            ...
            raise EarendelError(HTTPStatus.TOO_MANY_REQUESTS, msg, Codes.LIMIT_EXCEEDED)
        ...
        if expected_size == UNKNOWN_LENGTH:
            ...
            if int(expected_size) > max_size:
                ...
                raise EarendelError(HTTPStatus.BAD_GATEWAY, msg, Codes.TOO_LARGE)
    ...
    async def federation_get_file(
        ...
        Raises:
            ...
            RequestSendFailed: If there were problems connecting to the
                remote, due to e.g. DNS failures, connection timeouts etc.
            EarendelError: If the requested file exceeds ratelimits or the response from the
        ...
        try:
            ...
            raise EarendelError(HTTPStatus.BAD_GATEWAY, msg)
