...
class RequestTimedOutError(EarendelError):
...
class QuieterFileBodyProducer(FileBodyProducer):
    ...
    Workaround for https://github.com/sudhantechie/earendel/issues/4003 /
...
def get_request_user_agent(request: IRequest, default: str = "") -> str:
    ...
    # the charset problem.
    # c.f. https://github.com/sudhantechie/earendel/issues/3471
