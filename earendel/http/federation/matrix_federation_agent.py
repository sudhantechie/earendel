...
from earendel.config.server import ProxyConfig
from earendel.crypto.context_factory import FederationPolicyForHTTPS
from earendel.http import proxyagent
from earendel.http.client import BlocklistingAgentWrapper, BlocklistingReactorWrapper
from earendel.http.connectproxyclient import HTTPConnectProxyEndpoint
from earendel.http.federation.srv_resolver import Server, SrvResolver
from earendel.http.federation.well_known_resolver import WellKnownResolver
...
class MatrixFederationAgent:
    ...
    Earendel and we purposely want to avoid colliding with the `matrix://` URL scheme
