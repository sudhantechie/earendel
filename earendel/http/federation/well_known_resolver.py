...
from earendel.http.client import BodyExceededMaxSize, read_body_with_max_size
from earendel.logging.context import make_deferred_yieldable
from earendel.types import IEarendelThreadlessReactor
from earendel.util.caches.ttlcache import TTLCache
...
class WellKnownResolver:
    ...
    def __init__(
        self,
        server_name: str,
        reactor: IEarendelThreadlessReactor,
        clock: Clock,
        agent: IAgent,
        user_agent: bytes,
