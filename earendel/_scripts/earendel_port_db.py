...
from earendel.config.database import DatabaseConnectionConfig
...
from earendel.storage.database import DatabasePool, LoggingTransaction, make_conn
from earendel.storage.databases.main import FilteringWorkerStore
from earendel.storage.databases.main.account_data import AccountDataWorkerStore
from earendel.storage.databases.main.client_ips import ClientIpBackgroundUpdateStore
from earendel.storage.databases.main.delayed_events import DelayedEventsStore
from earendel.storage.databases.main.deviceinbox import DeviceInboxBackgroundUpdateStore
from earendel.storage.databases.main.devices import DeviceBackgroundUpdateStore
from earendel.storage.databases.main.e2e_room_keys import EndToEndRoomKeyBackgroundStore
from earendel.storage.databases.main.end_to_end_keys import EndToEndKeyBackgroundStore
from earendel.storage.databases.main.event_federation import EventFederationWorkerStore
from earendel.storage.databases.main.event_push_actions import EventPushActionsStore
from earendel.storage.databases.main.events_bg_updates import (
    EventsBackgroundUpdatesStore,
)
from earendel.storage.databases.main.media_repository import (
    MediaRepositoryBackgroundUpdateStore,
)
from earendel.storage.databases.main.presence import PresenceBackgroundUpdateStore
from earendel.storage.databases.main.profile import ProfileWorkerStore
from earendel.storage.databases.main.push_rule import PusherWorkerStore
from earendel.storage.databases.main.pusher import PusherBackgroundUpdatesStore
from earendel.storage.databases.main.receipts import ReceiptsBackgroundUpdateStore
from earendel.storage.databases.main.registration import (
    RegistrationBackgroundUpdateStore,
    find_max_generated_user_id_localpart,
)
from earendel.storage.databases.main.relations import RelationsWorkerStore
from earendel.storage.databases.main.room import RoomBackgroundUpdateStore
from earendel.storage.databases.main.roommember import RoomMemberBackgroundUpdateStore
from earendel.storage.databases.main.search import SearchBackgroundUpdateStore
from earendel.storage.databases.main.sliding_sync import SlidingSyncStore
from earendel.storage.databases.main.state import MainStateBackgroundUpdateStore
from earendel.storage.databases.main.stats import StatsStore
from earendel.storage.databases.main.user_directory import (
    UserDirectoryBackgroundUpdateStore,
)
from earendel.storage.databases.state.bg_updates import StateBackgroundUpdateStore
from earendel.storage.engines import create_engine
from earendel.storage.prepare_database import prepare_database
from earendel.types import IEarendelReactor

# Cast safety: Twisted does some naughty magic which replaces the
# twisted.internet.reactor module with a Reactor instance at runtime.
reactor = cast(IEarendelReactor, reactor_)
logger = logging.getLogger("earendel_port_db")
...
class Porter:
    ...
    async def handle_table(
        ...
        if table == "user_directory_stream_pos":
            ...
            # what earendel expects to be there.
            await self.postgres_store.db_pool.simple_insert(
    ...
    def build_db_store(
        ...
        Args:
            ...
            allow_outdated_version: True to suppress errors about the database server
                version being too old to run a complete earendel
        ...
        try:
            ...
            if await self.sqlite_store.db_pool.runInteraction(
                ...
                end_error = (
                    ...
                    " To disable auto_vacuum, you need to stop Earendel and run the following SQL:\n"
            ...
            if not updates_complete:
                end_error = (
                    ...
                    " Please start Earendel again and wait until every update has finished"
...
def main() -> None:
    parser = argparse.ArgumentParser(
        description="A script to port an existing earendel SQLite database to"
    ...
    parser.add_argument(
        ...
        " currently used by a running earendel server",
    )
    parser.add_argument(
        "--postgres-config",
    ...
    logging.basicConfig(
        ...
        filename="port-earendel.log" if args.curses else None,
    )
