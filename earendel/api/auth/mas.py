...
from earendel.api.auth.base import BaseAuth
...
from earendel.earendel_rust.http_client import HttpClient
from earendel.types import JsonDict, Requester, UserID, create_requester
...
class MasDelegatedAuth(BaseAuth):
    def __init__(self, hs: "HomeServer"):
        ...
        # - on Earendel (as requests are relatively expensive)
        # - on the network
        # - on MAS
        #
        # Since there is no invalidation mechanism currently,
        # the entries expire after 2 minutes.
        # This does mean tokens can be treated as valid by Earendel
        ...
        #   In this case, MAS will delete the device within Earendel
    ...
    def is_request_using_the_shared_secret(self, request: EarendelRequest) -> bool:
        """
    ...
    async def is_server_admin(self, requester: Requester) -> bool:
        return "urn:earendel:admin:*" in requester.scope
    ...
    async def get_user_by_access_token(
        ...
        try:
            ...
            raise EarendelError(503, "Unable to introspect the access token")
