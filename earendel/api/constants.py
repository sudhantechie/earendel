...
MAX_PDU_SIZE = 65536
# This isn't spec'ed but is our own reasonable default to play nice with Earendel's
...
# A transaction can contain up to 100 EDUs but earendel reserves 10 EDUs for other purposes
...
class UserTypes:
    ...
    """
    The user types that are built-in to Earendel. Extra user types can be
...
class AccountDataTypes:
    ...
    # Earendel-specific behaviour. See "Client-Server API Extensions" documentation
    # in Admin API for more information.
    EAREENDEL_ADMIN_CLIENT_CONFIG: Final = "io.element.earendel.admin_client_config"
