...
from earendel.api.constants import EduTypes, EventContentFields
...
from earendel.types import JsonDict, JsonMapping, RoomID, UserID
...
class Filtering:
    ...
    def check_valid_filter(self, user_filter_json: JsonDict) -> None:
        ...
        Raises:
            EarendelError: If the filter is not valid.
        """
