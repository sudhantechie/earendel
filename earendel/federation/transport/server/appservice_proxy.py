...
from earendel.federation.transport.server._base import Authenticator
from earendel.http import QuieterFileBodyProducer
from earendel.http.appservice_proxy import proxy_request_to_appservice
...
def _make_proxy_callback(
    ...
    async def _proxy(request: EarendelRequest, **kwargs: str) -> None:
        body_producer = None
        content = None
