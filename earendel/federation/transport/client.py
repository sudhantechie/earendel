...
from earendel.api.constants import Direction, Membership
...
from earendel.api.room_versions import RoomVersion
...
from earendel.federation.units import Transaction
from earendel.http.client import is_unknown_endpoint
from earendel.http.matrixfederationclient import ByteParser, LegacyJsonSendParser
from earendel.http.types import QueryParams
from earendel.types import JsonDict, UserID
from earendel.util import ExceptionBundle

if TYPE_CHECKING:
    from earendel.app.homeserver import HomeServer
...
class TransportLayerClient:
    ...
    async def get_public_rooms(
        ...
        See earendel.federation.federation_client.FederationClient.get_public_rooms for
        more information.
        """
