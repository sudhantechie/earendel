...
from earendel.api.errors import HttpResponseException
...
last_pdu_ts_metric = Gauge(
    "earendel_federation_last_sent_pdu_time",
...
class TransactionManager:
    ...
    def __init__(self, hs: "earendel.server.HomeServer"):
    ...
    async def send_new_transaction(
        ...
        with start_active_span_follows_from("send_transaction", span_contexts):
            ...
            #  https://github.com/sudhantechie/earendel/issues/8429.
