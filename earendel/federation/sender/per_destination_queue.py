...
from earendel.logging.opentracing import EarendelTags, set_tag
from earendel.metrics import SERVER_NAME_LABEL, sent_transactions_counter
from earendel.types import JsonDict, ReadReceipt
from earendel.util.retryutils import NotRetryingDestination, get_retry_limiter
from earendel.visibility import filter_events_for_server

if TYPE_CHECKING:
    import earendel.server

logger = logging.getLogger(__name__)


sent_edus_counter = Counter(
    "earendel_federation_client_sent_edus",
    "Total number of EDUs successfully sent",
    labelnames=[SERVER_NAME_LABEL],
)

sent_edus_by_type = Counter(
    "earendel_federation_client_sent_edus_by_type",
...
class PerDestinationQueue:
    ...
    def __init__(
        self,
        hs: "earendel.server.HomeServer",
        transaction_manager: "earendel.federation.sender.TransactionManager",
        destination: str,
    ):
        ...
        # https://github.com/sudhantechie/earendel/issues/7549
    ...
    async def _get_to_device_message_edus(self, limit: int) -> tuple[list[Edu], int]:
        ...
        for content in contents:
            ...
            set_tag(EarendelTags.TO_DEVICE_EDU_ID, message_id)
