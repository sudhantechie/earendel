...
*Catch-Up Mode*, entered upon Earendel startup or once a homeserver has fallen behind due to
...
This reduces load on the destination **in aggregate** because all Earendel homeservers
...
from earendel.federation.sender.per_destination_queue import (
    CATCHUP_RETRY_INTERVAL,
    PerDestinationQueue,
)
from earendel.federation.sender.transaction_manager import TransactionManager
from earendel.federation.units import Edu
...
from earendel.util.retryutils import filter_destinations_by_retry_limiter
...
sent_pdus_destination_dist_count = Counter(
    "earendel_federation_client_sent_pdu_destinations_count",
    "Number of PDUs queued for sending to one or more destinations",
    labelnames=[SERVER_NAME_LABEL],
)

sent_pdus_destination_dist_total = Counter(
    "earendel_federation_client_sent_pdu_destinations",
    "Total number of PDUs queued for sending across all destinations",
    labelnames=[SERVER_NAME_LABEL],
)

transaction_queue_pending_destinations_gauge = LaterGauge(
    name="earendel_federation_transaction_queue_pending_destinations",
    desc="",
    labelnames=[SERVER_NAME_LABEL],
)

transaction_queue_pending_pdus_gauge = LaterGauge(
    name="earendel_federation_transaction_queue_pending_pdus",
    desc="",
    labelnames=[SERVER_NAME_LABEL],
)

transaction_queue_pending_edus_gauge = LaterGauge(
    name="earendel_federation_transaction_queue_pending_edus",
    desc="",
    labelnames=[SERVER_NAME_LABEL],
)
...
class FederationSender(AbstractFederationSender):
        ...
        try:
            ...
            while not self._is_shutdown:
                ...
                async def handle_event(event: EventBase) -> None:
                    ...
                    if destinations is None:
                        ...
                        if sg:
                            ...
                            if destinations is None:
                                # Add logging to help track down https://github.com/sudhantechie/earendel/issues/13444
                                logger.info(
                    ...
                    if sharded_destinations:
                        ...
                        earendel.metrics.event_processing_lag_by_event.labels(
                ...
                if event_entries:
                    ...
                    earendel.metrics.event_processing_lag.labels(
                        name="federation_sender",
                        **{SERVER_NAME_LABEL: self.server_name},
                    ).set(now - ts)
                    earendel.metrics.event_processing_last_ts.labels(
                        name="federation_sender",
                        **{SERVER_NAME_LABEL: self.server_name},
                    ).set(ts)
    ...
    async def send_read_receipt(self, receipt: ReadReceipt) -> None:
        ...
        # https://github.com/sudhantechie/earendel/issues/4730.
