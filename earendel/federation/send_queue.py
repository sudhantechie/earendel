...
from earendel.replication.tcp.streams.federation import FederationStream
from earendel.types import JsonDict, ReadReceipt, RoomStreamToken, StrCollection
...
for queue_name in QueueNames:
    queue_name_to_gauge_map[queue_name] = LaterGauge(
        name=f"earendel_federation_send_queue_{queue_name.value}_size",
        desc="",
