...
from earendel.types import JsonDict, Requester
from earendel.util.hash import sha256_and_url_safe_base64
from earendel.util.json import json_decoder
from earendel.util.stringutils import (
...
class IdentityHandler:
    ...
    async def threepid_from_creds(
        ...
        try:
            ...
            raise EarendelError(500, "Timed out contacting identity server")
    ...
    async def bind_threepid(
        ...
        Raises:
            EarendelError: On any of the following conditions
    ...
    async def try_unbind_threepid(
        ...
        Raises:
            EarendelError: If we failed to contact one or more identity servers.
    ...
    async def _try_unbind_threepid_with_id_server(
        ...
        try:
            ...
            if e.code in (400, 404, 501):
                ...
                raise EarendelError(500, "Failed to contact identity server")
        except RequestTimedOutError:
            raise EarendelError(500, "Timed out contacting identity server")
    ...
    async def send_threepid_validation(
        ...
        Raises:
            EarendelError is an error occurred when sending the email
        """
        ...
        try:
            ...
            raise EarendelError(500, "An error was encountered when sending the email")
    ...
    async def proxy_msisdn_submit_token(
        ...
        Raises:
            EarendelError: If we failed to contact the identity server
        ...
        try:
            ...
            raise EarendelError(400, "Error contacting the identity server")
