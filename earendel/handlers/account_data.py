...
from earendel.replication.http.account_data import (
...
from earendel.types import JsonDict, JsonMapping, StrCollection, StreamKeyType, UserID
...
class AccountDataHandler:
    ...
    async def remove_account_data_for_room(
        ...
        if self._instance_name in self._account_data_writers:
            ...
            # Notify Earendel modules that the content of the type has changed to an
            # empty dictionary.
