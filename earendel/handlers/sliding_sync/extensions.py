...
from earendel.storage.databases.main.receipts import ReceiptInRoom
...
from earendel.types.rest.client import SlidingSyncStickyEventsToken
    ...
    async def get_receipts_extension_response(
        ...
        if len(relevant_room_ids) > 0:
            ...
            for room_id in relevant_room_ids:
                ...
                # `earendel.handlers.sliding_sync`).
        ...
        for profile_user_id in profile_user_ids:
            ...
            for field_name in user_fields:
                ...
                if (
                    ...
                    # by Earendel will have `avatar_url: None`, and we don't want to
