...
from earendel.storage.databases.main.room import LargestRoomStats
from earendel.types import JsonDict, JsonMapping, ThirdPartyInstanceID
    ...
    async def get_remote_public_room_list(
        ...
        if search_filter:
            ...
            try:
                ...
                earendel_err = hre.to_earendel_error()
                if hre.code in (404, 405) or earendel_err.errcode in (
                    Codes.UNRECOGNIZED,
                    Codes.NOT_FOUND,
                ):
                    ...
                    raise EarendelError(502, "Failed to fetch room list")
