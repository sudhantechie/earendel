...
from earendel.replication.http.login import RegisterDeviceReplicationServlet
from earendel.replication.http.register import (
    ReplicationPostRegisterActionsServlet,
)
from earendel.spam_checker_api import RegistrationBehaviour
from earendel.types import GUEST_USER_ID_PATTERN, RoomAlias, UserID, create_requester
...
class RegistrationHandler:
    ...
    async def check_username(
        ...
        if not localpart:
            raise EarendelError(400, "User ID cannot be empty", Codes.INVALID_USERNAME)
    ...
    async def register_user(
        ...
        Raises:
            EarendelError if there was a problem registering.
        """
        ...
        if result == RegistrationBehaviour.DENY:
            ...
            # denied.
            raise EarendelError(429, "Rate limited")
        ...
        if localpart is not None:
            ...
            while True:
                ...
                if fail_count > 10:
                    raise EarendelError(500, "Unable to find a suitable guest user ID")
