...
from earendel.api.filtering import FilterCollection
...
from earendel.handlers.relations import BundledAggregations
from earendel.logging import issue9533_logger
from earendel.logging.context import current_context
...
from earendel.storage.databases.main.event_push_actions import RoomNotifCounts
from earendel.storage.databases.main.roommember import extract_heroes_from_room_summary
from earendel.storage.databases.main.stream import PaginateFunction
...
from earendel.util.async_helpers import concurrently_execute
from earendel.util.caches.expiringcache import ExpiringCache
from earendel.util.caches.lrucache import LruCache
from earendel.util.caches.response_cache import ResponseCache, ResponseCacheContext
from earendel.util.cancellation import cancellable
from earendel.util.metrics import Measure
from earendel.visibility import filter_and_transform_events_for_client
...
non_empty_sync_counter = Counter(
    "earendel_handlers_sync_nonempty_total",
...
class SyncHandler:
    ...
    async def _wait_for_sync_for_user(
        ...
        if since_token is not None:
            # Work around a bug where older Earendel versions gave out tokens "from the
        ...
        # result, causing a tightloop. (https://github.com/sudhantechie/earendel/issues/8518)
    ...
    async def current_sync_for_user(
        ...
        with start_active_span("sync.current_sync_for_user"):
            ...
            set_tag(EarendelTags.SYNC_RESULT, bool(sync_result))
            return sync_result
        ...
        with Measure(
            ...
            if potential_recents:
                ...
                if any(e.is_state() for e in recents):
                    ...
                    # https://github.com/sudhantechie/earendel/issues/12989 is resolved,
    ...
    async def compute_summary(
        ...
        # FIXME: this promulgates https://github.com/sudhantechie/earendel/issues/3305
    ...
    def get_lazy_loaded_members_cache(
        ...
        # a sync is interrupted and retried, see https://github.com/sudhantechie/earendel/issues/19978
    ...
    async def _compute_state_delta_for_full_sync(
        ...
        if members_to_fetch is not None:
            ...
            # LL for incr syncs in https://github.com/sudhantechie/earendel/pull/3840.
            #
    ...
    async def generate_sync_result(
        ...
        # debug for https://github.com/sudhantechie/earendel/issues/9424
    ...
    async def _generate_room_entry(
        ...
        with start_active_span("sync.generate_room_entry"):
            ...
            # tag was added by earendel e.g. for server notice rooms.
            if full_state:
                user_id = sync_result_builder.sync_config.user.to_string()
...
def _calculate_state(
    ...
    # client.
    # see https://github.com/sudhantechie/earendel/pull/2970/files/efcdacad7d1b7f52f879179701c7e0d9b763511f#r204732809
