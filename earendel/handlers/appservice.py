...
import earendel
from earendel.api.constants import EduTypes, EventTypes
...
from earendel.storage.databases.main.directory import RoomAliasMapping
...
events_processed_counter = Counter(
    "earendel_handlers_appservice_events_processed", "", labelnames=[SERVER_NAME_LABEL]
)
