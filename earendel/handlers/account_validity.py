...
from earendel.api.errors import AuthError, StoreError, EarendelError
...
class AccountValidityHandler:
    ...
    async def send_renewal_email_to_user(self, user_id: str) -> None:
        ...
        Raises:
            EarendelError if the user is not set to renew.
        """
        ...
        if expiration_ts is None:
            raise EarendelError(400, "User has no expiration time: %s" % (user_id,))
