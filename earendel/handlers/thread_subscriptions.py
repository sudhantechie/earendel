    ...
    async def subscribe_user_to_thread(
        ...
        *,
        ...
        Raises:
            ...
            EarendelError(400, M_NOT_IN_THREAD): if client supplied an automatic cause event
            but user cannot access the event.

            EarendelError(409, M_SKIPPED): if client requested an automatic subscription
