...
from earendel.api.errors import AuthError, Codes, EarendelError
...
from earendel.handlers.room_member import get_users_which_can_issue_invite
...
class EventAuthHandler:
    ...
    async def get_user_which_could_invite(
        ...
        Raises:
            EarendelError if no appropriate user is found.
        """
