...
from earendel.api.errors import Codes, EventSizeError, EarendelError
...
from earendel.types import JsonDict, Requester, StreamKeyType, UserID, get_domain_from_id
from earendel.util import split_dict_to_fit_to_size
...
class DeviceMessageHandler:
    ...
    async def send_device_message(
        ...
        set_tag(EarendelTags.TO_DEVICE_TYPE, message_type)
        set_tag(EarendelTags.TO_DEVICE_SENDER, sender_user_id)
        local_messages = {}
