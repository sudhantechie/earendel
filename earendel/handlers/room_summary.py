...
from earendel.config.ratelimiting import RatelimitSettings
from earendel.events import EventBase
from earendel.types import JsonDict, Requester, StrCollection
...
class RoomSummaryHandler:
    ...
    async def _get_room_hierarchy(
        ...
        if from_token:
            try:
                ...
                raise EarendelError(400, "Unknown pagination token", Codes.INVALID_PARAM)
    ...
    async def get_federation_hierarchy(
        ...
        if root_room_entry is None:
            ...
            raise EarendelError(404, "Unknown room: %s" % (requested_room_id,))
    ...
    async def get_room_summary(
        ...
        if is_in_room:
            ...
            if remote_room_hosts is None:
                raise EarendelError(400, "Missing via to query remote room")
