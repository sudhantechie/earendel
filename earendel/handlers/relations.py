...
from earendel.api.constants import Direction, EventTypes, RelationTypes
...
from earendel.storage.databases.main.relations import ThreadsNextBatch, _RelatedEvent
...
# `earendel.handlers.relations`.
from earendel.earendel_rust.events import (  # noqa: F401
    BundledAggregations,
    ThreadAggregation,
)
from earendel.earendel_rust.room_versions import RoomVersion
from earendel.types import JsonDict, Requester, UserID
...
class RelationsHandler:
    ...
    async def get_relations(
        ...
        if event is None:
            raise EarendelError(404, "Unknown parent event.")
