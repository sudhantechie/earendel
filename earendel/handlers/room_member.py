...
from earendel.event_auth import get_named_level, get_power_level_event
from earendel.events import EventBase, is_creator
from earendel.events.snapshot import EventContext
from earendel.handlers.pagination import PURGE_ROOM_ACTION_NAME
from earendel.handlers.profile import MAX_AVATAR_URL_LEN, MAX_DISPLAYNAME_LEN
from earendel.handlers.state_deltas import MatchChange, StateDeltasHandler
from earendel.handlers.worker_lock import NEW_EVENT_DURING_PURGE_LOCK_NAME
from earendel.logging import opentracing
from earendel.logging.opentracing import EarendelTags, set_tag, tag_args, trace
from earendel.metrics import SERVER_NAME_LABEL, event_processing_positions
from earendel.replication.http.push import ReplicationCopyPusherRestServlet
...
from earendel.util.distributor import user_left_room
...
class NoKnownServersError(EarendelError):
...
class RoomMemberHandler(metaclass=abc.ABCMeta):
    ...
    async def forget(
        ...
        if membership is not None and membership not in [
            ...
            raise EarendelError(400, "User %s in room %s" % (user_id, room_id))
    ...
    async def update_membership(
        ...
        Params:
            ...
            action: The membership change, see earendel.api.constants.Membership.
    ...
    async def update_membership_locked(
        ...
        if "avatar_url" in content and content.get("avatar_url") is not None:
            if not await self.profile_handler.check_avatar_size_and_mime_type(
                ...
                raise EarendelError(403, "This avatar is not allowed", Codes.FORBIDDEN)
        ...
        if effective_membership_state not in Membership.LIST:
            raise EarendelError(400, "Invalid membership key")
        ...
        if effective_membership_state == Membership.JOIN:
            ...
            if not is_host_in_room:
                ...
                if not current_membership_type or not current_membership_event_id:
                    ...
                    raise EarendelError(404, "Not a known room")
                ...
                if current_membership_type == Membership.INVITE:
                    ...
                    #
                    # see: https://github.com/sudhantechie/earendel/issues/7139
    ...
    async def _should_perform_remote_join(
        ...
        * The server is in the room, the room has restricted join rules, the user
        ...
        set_tag(
            EarendelTags.RESULT_PREFIX + "previous_membership",
        ...
        current_state = {
            ...
            #  See https://github.com/sudhantechie/earendel/issues/19465
        ...
        set_tag(
            EarendelTags.RESULT_PREFIX + "servers_that_can_issue_invite",
    ...
    async def send_membership_event(
        ...
        Raises:
            EarendelError if there was a problem changing the membership.
    ...
    async def lookup_room_alias(
        ...
        Raises:
            EarendelError if room alias could not be found.
        """
        directory_handler = self.directory_handler
        mapping = await directory_handler.get_association(room_alias)

        if not mapping:
            raise EarendelError(404, "No such room alias")
