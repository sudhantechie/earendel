...
from earendel.api.constants import Membership
from earendel.api.errors import EarendelError
from earendel.replication.http.deactivate_account import (
    ReplicationNotifyAccountDeactivatedServlet,
)
from earendel.types import Codes, Requester, UserID, create_requester
    ...
    async def deactivate_account(
        ...
        for medium, address in bound_threepids:
            try:
                ...
                raise EarendelError(400, "Failed to remove threepid from ID server")
