...
from earendel.replication.http.profile import (
...
from earendel.util.stringutils import parse_and_validate_mxc_uri
...
class ProfileHandler:
    ...
    async def get_profile(self, user_id: str, ignore_backoff: bool = True) -> JsonDict:
        ...
        if self.hs.is_mine(target_user):
            ...
            if (
                ...
                raise EarendelError(404, "Profile was not found", Codes.NOT_FOUND)
            ...
            try:
                ...
                raise EarendelError(502, "Failed to fetch profile") from e
                ...
                if e.code < 500 and e.code not in (403, 404):
                    ...
                    raise EarendelError(502, "Failed to fetch profile")
    ...
    async def set_profile_field(
        ...
        *,
        ...
        if await self.store.get_user_by_id(target_user.to_string()) is None:
            raise EarendelError(404, "User not found", Codes.NOT_FOUND)
    ...
    async def check_profile_query_allowed(
        ...
        Raises:
            EarendelError(403): The two users share no room, or ne user couldn't
        ...
        try:
            ...
            if requester_rooms.isdisjoint(target_user_rooms):
                raise EarendelError(403, "Profile isn't available", Codes.FORBIDDEN)
        except StoreError as e:
            if e.code == 404:
