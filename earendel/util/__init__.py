...
EAREENDEL_VERSION = os.getenv(
    "EAREENDEL_VERSION_STRING"
) or get_distribution_version_string("matrix-earendel", __file__)
"""
Version string with git info.

This can be overridden via the `EAREENDEL_VERSION_STRING` environment variable or is
