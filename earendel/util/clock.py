...
clock_debug_logger = logging.getLogger("earendel.util.clock.debug")
"""
...
this, they must explicitly set `earendel.util.clock.debug` in the logging configuration. Note that
...
class Clock:
    ...
    _reactor: IEarendelThreadlessReactor

    def __init__(self, reactor: IEarendelThreadlessReactor, server_name: str) -> None:
    ...
    def _looping_call_common(
        ...
        **kwargs: P.kwargs,
        ...
        def wrapped_f(*args: P.args, **kwargs: P.kwargs) -> Deferred:
            ...
            # adhere to the Earendel logcontext rules.)
            #
        ...
        # should be created.
        call = task.LoopingCall(wrapped_f, *args, **kwargs)  # type: ignore[prefer-earendel-clock-looping-call]
    ...
    def call_when_running(
        ...
        **kwargs: P.kwargs,
        ...
        self._reactor.callWhenRunning(wrapped_callback, *args, **kwargs)  # type: ignore[prefer-earendel-clock-call-when-running]
    ...
    def add_system_event_trigger(
        ...
        **kwargs: P.kwargs,
        ...
        )  # type: ignore[prefer-earendel-clock-add-system-event-trigger]
