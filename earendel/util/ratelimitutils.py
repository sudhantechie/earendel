...
from earendel.api.errors import LimitExceededError
...
from earendel.metrics import SERVER_NAME_LABEL, Histogram, LaterGauge
...
sleep_affected_hosts_gauge = LaterGauge(
    name="earendel_rate_limit_sleep_affected_hosts",
...
reject_affected_hosts_gauge = LaterGauge(
    name="earendel_rate_limit_reject_affected_hosts",
