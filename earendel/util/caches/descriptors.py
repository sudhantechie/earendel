...
from earendel.logging.context import make_deferred_yieldable, preserve_fn
from earendel.util import unwrapFirstError
from earendel.util.async_helpers import delay_cancellation
from earendel.util.caches.deferred_cache import DeferredCache
...
class CachedFunction(Generic[F]):
    ...
    # Note: This function signature is actually fiddled with by the earendel mypy
