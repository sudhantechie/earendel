...
from earendel.metrics import SERVER_NAME_LABEL, InFlightGauge
...
block_counter = Counter(
    "earendel_util_metrics_block_count",
...
block_timer = Counter(
    "earendel_util_metrics_block_time_seconds",
...
block_ru_utime = Counter(
    "earendel_util_metrics_block_ru_utime_seconds",
...
block_ru_stime = Counter(
    "earendel_util_metrics_block_ru_stime_seconds",
...
block_db_txn_count = Counter(
    "earendel_util_metrics_block_db_txn_count",
...
block_db_txn_duration = Counter(
    "earendel_util_metrics_block_db_txn_duration_seconds",
...
block_db_sched_duration = Counter(
    "earendel_util_metrics_block_db_sched_duration_seconds",
...
in_flight: InFlightGauge[_BlockInFlightMetric] = InFlightGauge(
    "earendel_util_metrics_block_in_flight",
