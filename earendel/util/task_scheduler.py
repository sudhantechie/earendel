...
from earendel.types import JsonMapping, ScheduledTask, TaskStatus
...
running_tasks_gauge = LaterGauge(
    name="earendel_scheduler_running_tasks",
...
class TaskScheduler:
    ...
    The issue is that these tasks stop completely and won't resume if Earendel is
    ...
    - Register an Action: First, you need to register a function to a named
      ...
      after a Earendel shutdown. Make sure to register it when Earendel initializes,
    ...
    async def update_task(
        ...
        *,
        ...
        a task at a specific step after a restart of earendel.
