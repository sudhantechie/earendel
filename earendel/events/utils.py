...
from earendel.logging.opentracing import EarendelTags, set_tag, trace
from earendel.earendel_rust.events import (
    EventFormat,
...
# the future; nothing in Earendel itself should use them.
__all__ = [
    "EventFormat",
    "SerializeEventConfig",
    "format_event_for_client_v1",
...
class FilteredEvent:
    ...
    This is None if we didn't compute the membership. In Earendel this happens a)
    ...
    * NaN, Infinity, -Infinity
    ...
    if type(value) is int:  # noqa: E721
        if value < CANONICALJSON_MIN_INT or CANONICALJSON_MAX_INT < value:
            raise EarendelError(400, "JSON integer out of range", Codes.BAD_JSON)

    elif isinstance(value, float):
        # Note that Infinity, -Infinity, and NaN are also considered floats.
        raise EarendelError(400, "Bad JSON value: float", Codes.BAD_JSON)
        ...
        raise EarendelError(400, "Unknown JSON value", Codes.BAD_JSON)
