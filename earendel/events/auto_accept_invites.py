...
from earendel.api.constants import AccountDataTypes, EventTypes, Membership
from earendel.api.errors import EarendelError
from earendel.config.auto_accept_invites import AutoAcceptInvitesConfig
from earendel.module_api import EventBase, ModuleApi, run_as_background_process
        ...
        while retries < 5:
            try:
                ...
                if e.code == HTTPStatus.FORBIDDEN:
                    ...
                    logger.warning(
                        "Update_room_membership raised the following unexpected (EarendelError) exception: %s",
                        e,
                    )
