...
from earendel.util.rust import check_rust_lib_up_to_date
...
if py_version < (3, 10):
    print("Earendel requires Python 3.10 or above.")
    sys.exit(1)

# Allow using the asyncio reactor via env var.
if strtobool(os.environ.get("EAREENDEL_ASYNC_IO_REACTOR", "0")):
    import asyncio
...
# actually start Earendel will import these libraries fine.
try:
...
try:
    ...
    from earendel.earendel_rust.events import JsonObject  # noqa: E402

    register_preserialisation_callback(JsonObject, lambda obj: dict(obj))
except ImportError:
    pass

import earendel.util  # noqa: E402

__version__ = earendel.util.EAREENDEL_VERSION

if bool(os.environ.get("EAREENDEL_TEST_PATCH_LOG_CONTEXTS", False)):
    # We import here so that we don't have to install a bunch of deps when
    # running the packaging tox test.
    from earendel.util.patch_inline_callbacks import do_patch
