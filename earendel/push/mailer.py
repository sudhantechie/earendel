...
from earendel.api.constants import EventContentFields, EventTypes, Membership, RoomTypes
from earendel.api.errors import StoreError
from earendel.config.emailconfig import EmailSubjectConfig
from earendel.events import EventBase
from earendel.metrics import SERVER_NAME_LABEL
from earendel.push.presentable_names import (
    calculate_room_name,
    descriptor_from_member_events,
    name_from_member_event,
)
from earendel.push.push_types import (
    EmailReason,
    MessageVars,
    NotifVars,
    RoomVars,
...
from earendel.types import StateMap, UserID
...
class Mailer:
    ...
    async def send_email(
        ...
        await self.send_email_handler.send_email(
            ...
            #
            # It is preferred to use email, but Earendel doesn't support incoming email.
            #
