...
from earendel.api.room_versions import PushRuleRoomFlag
from earendel.event_auth import auth_types_for_event, get_user_power_level
...
from earendel.storage.roommember import ProfileInfo
from earendel.earendel_rust.push import FilteredPushRules, PushRuleEvaluator
from earendel.types import JsonMapping, JsonValue
...
from earendel.util.caches import register_cache
from earendel.util.metrics import measure_func
from earendel.visibility import filter_event_for_clients_with_state
...
push_rules_invalidation_counter = Counter(
    "earendel_push_bulk_push_rule_evaluator_push_rules_invalidation_counter",
    "",
    labelnames=[SERVER_NAME_LABEL],
)
# FIXME: Unused metric, remove if not needed.
push_rules_state_size_counter = Counter(
    "earendel_push_bulk_push_rule_evaluator_push_rules_state_size_counter",
    "",
    labelnames=[SERVER_NAME_LABEL],
)
...
class BulkPushRuleEvaluator:
    ...
    async def _action_for_event_by_user(
        ...
        #
        # See https://github.com/sudhantechie/earendel/issues/16606
        (
            room_member_count,
