...
from earendel.push.pusher import PusherFactory
from earendel.replication.http.push import (
    ReplicationDeleteAllPushersForUserRestServlet,
    ReplicationRemovePusherRestServlet,
)
from earendel.types import JsonDict, RoomStreamToken, StrCollection
...
earendel_pushers = Gauge(
    "earendel_pushers",
    "Number of active earendel pushers",
