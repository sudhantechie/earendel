...
from earendel.api.errors import NotFoundError, StoreError, EarendelError
from earendel.config import ConfigError
from earendel.http.server import DirectServeHtmlResource, respond_with_html
from earendel.http.servlet import parse_bytes_from_args, parse_string
...
class ConsentResource(DirectServeHtmlResource):
    ...
    def _check_hash(self, userid: str, userhmac: bytes) -> None:
        ...
        Raises:
              EarendelError if the hash doesn't match
