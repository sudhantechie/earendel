...
from earendel.federation.transport.server import Authenticator
from earendel.http.servlet import RestServlet, parse_enum, parse_integer, parse_string
...
from earendel.storage.databases.main.transactions import DestinationSortOrder
...
class DestinationRestServlet(RestServlet):
    ...
    async def on_GET(
        self, request: EarendelRequest, destination: str
    ) -> tuple[int, JsonDict]:
        await assert_requester_is_admin(self._auth, request)
