...
class RegistrationTokenRestServlet(RestServlet):
    ...
    async def on_GET(self, request: EarendelRequest, token: str) -> tuple[int, JsonDict]:
    ...
    async def on_PUT(self, request: EarendelRequest, token: str) -> tuple[int, JsonDict]:
    ...
    async def on_DELETE(
        self, request: EarendelRequest, token: str
    ) -> tuple[int, JsonDict]:
