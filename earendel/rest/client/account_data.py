...
from earendel.api.constants import AccountDataTypes, ReceiptTypes
...
from earendel.types import JsonDict, JsonMapping, RoomID
...
class AccountDataServlet(RestServlet):
    ...
    async def on_PUT(
        self, request: EarendelRequest, user_id: str, account_data_type: str
    ) -> tuple[int, JsonDict]:
