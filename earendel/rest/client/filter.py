...
from earendel.api.errors import AuthError, NotFoundError, StoreError, EarendelError
...
class GetFilterRestServlet(RestServlet):
    ...
    async def on_GET(
        self, request: EarendelRequest, user_id: str, filter_id: str
        ...
        try:
            ...
            raise EarendelError(400, "Invalid filter_id")
