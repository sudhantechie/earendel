...
from earendel.api.constants import AccountDataTypes, EduTypes, Membership, PresenceState
...
from earendel.handlers.presence import format_user_presence_state
from earendel.handlers.sliding_sync import SlidingSyncConfig, SlidingSyncResult
from earendel.handlers.sync import (
    ArchivedSyncResult,
    InvitedSyncResult,
    JoinedSyncResult,
    KnockedSyncResult,
...
from earendel.logging.opentracing import log_kv, set_tag, trace_with_opname
from earendel.rest.admin.experimental_features import ExperimentalFeature
...
from earendel.types.rest.client import SlidingSyncBody
...
class SyncRestServlet(RestServlet):
    ...
    async def on_GET(self, request: EarendelRequest) -> tuple[int, JsonDict]:
        ...
        if filter_id is None:
            ...
            try:
                ...
                raise EarendelError(400, "Invalid filter JSON", errcode=Codes.NOT_JSON)
            ...
            try:
                ...
                raise EarendelError(400, "No such filter", errcode=Codes.INVALID_PARAM)
    ...
    async def encode_response(
        ...
        # Corresponding earendel issue: https://github.com/sudhantechie/earendel/issues/10456
    ...
    async def encode_extensions(
        ...
        if extensions.e2ee is not None:
            serialized_extensions["e2ee"] = {
                ...
                # absent Corresponding earendel issue:
                # https://github.com/sudhantechie/earendel/issues/10456
