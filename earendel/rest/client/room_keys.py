...
class RoomKeysServlet(RestServlet):
    ...
    async def on_PUT(
        self, request: EarendelRequest, room_id: str | None, session_id: str | None
    ) -> tuple[int, JsonDict]:
        """
...
class RoomKeysNewVersionServlet(RestServlet):
    ...
    async def on_GET(self, request: EarendelRequest) -> tuple[int, JsonDict]:
        ...
        try:
            ...
            if e.code == 404:
                raise EarendelError(404, "No backup found", Codes.NOT_FOUND)
        return 200, info
...
class RoomKeysVersionServlet(RestServlet):
    ...
    async def on_GET(
        self, request: EarendelRequest, version: str
    ) -> tuple[int, JsonDict]:
        """
