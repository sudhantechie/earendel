...
from earendel.types.handlers.sliding_sync import SlidingSyncResult
from earendel.types.rest import RequestBodyModel
from earendel.util.pydantic_models import AnyEventId
...
class ThreadSubscriptionsRestServlet(RestServlet):
    ...
    async def on_GET(
        self, request: EarendelRequest, room_id: str, thread_root_id: str
    ) -> tuple[int, JsonDict]:
