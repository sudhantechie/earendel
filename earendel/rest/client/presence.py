...
from earendel.api.errors import AuthError, Codes, LimitExceededError, EarendelError
        ...
        try:
            ...
            if "status_msg" in content:
                ...
                if not isinstance(state["status_msg"], str):
                    raise EarendelError(400, "status_msg must be a string.")
            ...
            raise EarendelError(400, "Unable to parse state")
