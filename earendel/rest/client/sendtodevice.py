...
from earendel.http import servlet
from earendel.http.server import HttpServer
from earendel.http.servlet import assert_params_in_dict, parse_json_object_from_request
...
class SendToDeviceRestServlet(servlet.RestServlet):
    ...
    async def on_PUT(
        self, request: EarendelRequest, message_type: str, txn_id: str
    ) -> tuple[int, JsonDict]:
