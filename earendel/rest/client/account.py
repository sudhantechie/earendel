...
from earendel.types.rest.client import (
    AuthenticationData,
    ClientSecretStr,
...
from earendel.util.threepids import check_3pid_allowed, validate_email
...
class EmailPasswordRequestTokenRestServlet(RestServlet):
    ...
    async def on_POST(self, request: EarendelRequest) -> tuple[int, JsonDict]:
        ...
        if existing_user_id is None:
            ...
            raise EarendelError(400, "Email not found", Codes.THREEPID_NOT_FOUND)

        # Send password reset emails from Earendel
            ...
            if self.auth.has_access_token(request):
                ...
                if LoginType.EMAIL_IDENTITY in result:
                    ...
                    if "medium" not in threepid or "address" not in threepid:
                        raise EarendelError(500, "Malformed threepid")
                    ...
                    raise EarendelError(500, "", Codes.UNKNOWN)
...
class EmailThreepidRequestTokenRestServlet(RestServlet):
    ...
    async def on_POST(self, request: EarendelRequest) -> tuple[int, JsonDict]:
        ...
        # Send threepid validation emails from Earendel
        sid = await self.identity_handler.send_threepid_validation(
            body.email,
            body.client_secret,
            body.send_attempt,
...
class MsisdnThreepidRequestTokenRestServlet(RestServlet):
    ...
    async def on_POST(self, request: EarendelRequest) -> tuple[int, JsonDict]:
        ...
        if existing_user_id is not None:
            ...
            raise EarendelError(400, "MSISDN is already in use", Codes.THREEPID_IN_USE)
...
class ThreepidDeleteRestServlet(RestServlet):
    ...
    async def on_POST(self, request: EarendelRequest) -> tuple[int, JsonDict]:
        ...
        try:
            ...
            raise EarendelError(500, "Failed to remove threepid")
...
def assert_valid_next_link(hs: "HomeServer", next_link: str) -> None:
    """
    Raises a EarendelError if a given next_link value is invalid
    ...
    Raises:
        EarendelError: If the next_link is invalid
    """
    valid = True
