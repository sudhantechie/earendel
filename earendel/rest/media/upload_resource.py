...
from earendel.http.servlet import RestServlet, parse_bytes_from_args
from earendel.http.site import EarendelRequest
from earendel.media.media_storage import SpamMediaException
...
class BaseUploadServlet(RestServlet):
    ...
    async def _get_file_metadata(
        ...
        if raw_content_length is None:
            raise EarendelError(msg="Request must specify a Content-Length", code=400)
        try:
            content_length = int(raw_content_length)
        except ValueError:
            raise EarendelError(msg="Content-Length value is invalid", code=400)
...
class UploadServlet(BaseUploadServlet):
    ...
    async def on_POST(self, request: EarendelRequest) -> None:
        ...
        try:
            ...
            raise EarendelError(400, "Bad content")
