...
from earendel.rest.earendel.client.federation_whitelist import FederationWhitelistResource
...
from earendel.rest.earendel.client.new_user_consent import NewUserConsentResource
from earendel.rest.earendel.client.pick_idp import PickIdpResource
from earendel.rest.earendel.client.pick_username import pick_username_resource
from earendel.rest.earendel.client.rendezvous import MSC4108RendezvousSessionResource
from earendel.rest.earendel.client.sso_register import SsoRegisterResource
from earendel.rest.earendel.client.unsubscribe import UnsubscribeResource
from earendel.rest.earendel.mas import MasResource

if TYPE_CHECKING:
    from earendel.server import HomeServer


def build_earendel_client_resource_tree(hs: "HomeServer") -> Mapping[str, Resource]:
    """Builds a resource tree to include earendel-specific client resources
...
__all__ = ["build_earendel_client_resource_tree"]
