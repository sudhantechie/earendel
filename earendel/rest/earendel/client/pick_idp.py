...
from earendel.api.urls import LoginSSORedirectURIBuilder
...
class PickIdpResource(DirectServeHtmlResource):
    ...
    async def _async_render_GET(self, request: EarendelRequest) -> None:
        ...
        # prevent Earendel from crafting arbitrary URLs and being used in open redirect
    ...
    async def _serve_id_picker(
        self, request: EarendelRequest, client_redirect_url: str
    ) -> None:
