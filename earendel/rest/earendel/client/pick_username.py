...
from earendel.handlers.sso import get_username_mapping_session_cookie_from_request
from earendel.http.server import (
    DirectServeHtmlResource,
    DirectServeJsonResource,
    respond_with_html,
)
from earendel.http.servlet import parse_boolean, parse_string
from earendel.http.site import EarendelRequest
from earendel.types import JsonDict
from earendel.util.templates import build_jinja_env
...
class AccountDetailsResource(DirectServeHtmlResource):
    ...
    async def _async_render_POST(self, request: EarendelRequest) -> None:
        ...
        try:
            ...
            try:
                ...
                raise EarendelError(400, "Query parameter use_email must be utf-8")
        except EarendelError as e:
