...
from earendel.http.servlet import parse_enum, parse_integer, parse_string
from earendel.http.site import EarendelRequest
from earendel.storage.databases.main import DataStore
from earendel.types import StreamToken
...
class PaginationConfig:
    ...
    async def from_request(
        ...
        try:
            ...
            raise EarendelError(400, "'from' parameter is invalid")
        ...
        try:
            ...
            raise EarendelError(400, "'to' parameter is invalid")
        ...
        try:
            ...
            raise EarendelError(400, "Invalid request.")
