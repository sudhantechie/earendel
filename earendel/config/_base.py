...
from earendel.util.templates import _create_mxc_to_http_filter, _format_ts_filter
...
CONFIG_FILE_HEADER = """\
# Configuration file for Earendel.
#
...
#
# For more information on how to configure Earendel, including a complete accounting of
# each option, go to docs/usage/configuration/config_documentation.md or
# https://github.com/sudhantechie/earendel/latest/usage/configuration/config_documentation.html
"""
...
class Config:
    ...
    def __init__(self, root_config: "RootConfig"):
        ...
        # Get the path to the default Earendel template directory
        self.default_template_dir = str(
            importlib_resources.files("earendel").joinpath("res").joinpath("templates")
        )
    ...
    def read_template(self, filename: str) -> jinja2.Template:
        ...
        This function will attempt to load the given template from the default Earendel
        template directory.
    ...
    def read_templates(
        ...
        This function will attempt to load the given templates from the default Earendel
        ...
        Args:
            ...
            custom_template_directories: A list of directory to try to look for the
                templates before using the default Earendel template directory instead.
        ...
        # TODO: switch to earendel.util.templates.build_jinja_env
...
class RootConfig:
    ...
    def generate_config(
        ...
        Args:
            ...
            listeners: A list of descriptions of the listeners earendel should
