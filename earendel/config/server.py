...
Please see https://github.com/sudhantechie/earendel/latest/upgrade.html#direct-tcp-replication-is-no-longer-supported-migrate-to-redis
"""
...
The metrics_port configuration option is deprecated in Earendel 0.31 in favour of
a listener. Please see
https://github.com/sudhantechie/earendel/latest/metrics-howto.html
...
class ProxyConfig:
    """
    Earendel configuration for HTTP proxy settings.
    """
    ...
    proxy. Earendel will directly connect to these hosts.
    """
...
def parse_proxy_config(config: JsonDict) -> ProxyConfig:
    ...
    # List of hosts which should not use the proxy. Earendel will directly connect to
    # these hosts.
