...
from earendel.config._base import Config, ConfigError
...
unless 'room_invite_state_types' is removed. See the config documentation at
    https://github.com/sudhantechie/earendel/latest/usage/configuration/config_documentation.html#room_prejoin_state
