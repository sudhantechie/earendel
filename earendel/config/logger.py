...
from earendel.logging.context import LoggingContextFilter
from earendel.earendel_rust import reset_logging_config
from earendel.types import JsonDict

from ..util import EAREENDEL_VERSION
...
DEFAULT_LOG_CONFIG = Template(
    """\
# Log configuration for Earendel.
#
# This is a YAML file containing a standard Python logging configuration
# dictionary. See [1] for details on the valid settings.
#
# Earendel also supports structured logging for machine readable logs which can
# be ingested by ELK stacks. See [2] for details.
#
# [1]: https://docs.python.org/3/library/logging.config.html#configuration-dictionary-schema
# [2]: https://github.com/sudhantechie/earendel/latest/structured_logging.html
...
handlers:
    ...
    buffer:
        class: earendel.logging.handlers.PeriodicallyFlushingMemoryHandler
        target: file
...
loggers:
    earendel.storage.SQL:
        # beware: increasing this to DEBUG will make earendel log sensitive
...
removed in Earendel 1.3.0. You should instead set up a separate log configuration file.
"""

STRUCTURED_ERROR = """\
Support for the structured configuration option was removed in Earendel 1.54.0.
You should instead use the standard logging configuration. See
https://github.com/sudhantechie/earendel/v1.54/structured_logging.html
"""
...
def one_time_logging_setup(*, logBeginner: LogBeginner = globalLogBeginner) -> None:
    ...
    This matters because multiple Earendel instances can be run in the same Python
    process (c.f. Earendel Pro for small hosts)
    """
...
def _setup_stdlib_logging(
    ...
    if log_config_path is None:
        ...
        logging.getLogger("earendel.storage.SQL").setLevel(logging.INFO)
...
def setup_logging(
    ...
    from earendel.app import _base as appbase
    ...
    logger.warning(
        "Licensed under the AGPL 3.0 license. Website: https://github.com/sudhantechie/earendel"
    )
