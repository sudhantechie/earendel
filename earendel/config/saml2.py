...
from earendel.util.module_loader import load_module, load_python_module
...
DEFAULT_USER_MAPPING_PROVIDER = "earendel.handlers.saml.DefaultSamlMappingProvider"
...
LEGACY_USER_MAPPING_PROVIDER = (
    "earendel.handlers.saml_handler.DefaultSamlMappingProvider"
)
    ...
    def _default_saml_config_dict(
        ...
        Args:
            ...
            optional_attributes: SAML auth response attributes that can be used to add
                additional information to Earendel user accounts, but are not required
