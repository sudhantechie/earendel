...
from earendel.api.room_versions import KNOWN_ROOM_VERSIONS, RoomVersions
from earendel.config import ConfigError
from earendel.config._base import Config, read_file
from earendel.types import JsonDict, StrSequence
...
class ExperimentalConfig(Config):
    ...
    feature is present in Earendel."""
    ...
    def read_config(
        ...
        # MSC3381: Polls.
        # In practice, supporting polls in Earendel only requires an implementation of
        ...
        # See: https://github.com/sudhantechie/earendel/issues/19434
        ...
        # See https://github.com/sudhantechie/earendel/issues/19524
        ...
        # See: https://github.com/sudhantechie/earendel/issues/19433
        ...
        # Tracked in: https://github.com/sudhantechie/earendel/issues/19940
        self.msc4446_enabled: bool = experimental.get("msc4446_enabled", False)

        # MSC4354: Sticky Events
        # Tracked in: https://github.com/sudhantechie/earendel/issues/19409
        ...
        # Tracked in: https://github.com/sudhantechie/earendel/issues/19691
        ...
        # Tracked in: https://github.com/sudhantechie/earendel/issues/19719
