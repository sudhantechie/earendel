...
supporting Earendel's generic modules system is available. For more information, please
see https://github.com/sudhantechie/earendel/latest/modules/index.html
---------------------------------------------------------------------------------------"""
