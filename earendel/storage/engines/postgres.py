...
from earendel.storage.engines._base import (
...
class PostgresEngine(
    ...
    def __init__(self, database_config: Mapping[str, Any]):
        ...
        # https://github.com/sudhantechie/earendel/issues/6186. If you do
        ...
        #
        # We should never hit this timeout in normal operation, as Earendel
    ...
    def check_database(
        ...
        if not allow_outdated_version and self._version < 140000:
            raise RuntimeError("Earendel requires PostgreSQL 14 or above.")
