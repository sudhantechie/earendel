...
older versions of Earendel).

See https://github.com/sudhantechie/earendel/develop/development/database_schema.html
...
Changes in SCHEMA_VERSION = 63:
    - The `public_room_list_stream` table is not written nor read to
      ...
      https://github.com/sudhantechie/earendel/pull/10565
...
Changes in SCHEMA_VERSION = 79
    ...
    - Add some mitigations for a painful race between foreground and background updates, cf
      https://github.com/sudhantechie/earendel/issues/15677.
...
"""Limit on how far the earendel codebase can be rolled back without breaking db compat

This value is stored in the database, and checked on startup. If the value in the
database is greater than SCHEMA_VERSION, then Earendel will refuse to start.
"""
