...
from earendel.storage.types import Connection, Cursor
...
class BackgroundUpdater:
    ...
    def register_update_controller_callbacks(
        ...
        if self._on_update_callback is not None:
            logger.warning(
                ...
                " (in order of appearance in Earendel's configuration file) that tried to"
    ...
    async def create_index_in_background(
        ...
        def create_index_sqlite(conn: "LoggingDatabaseConnection") -> None:
            ...
            # background_updates not having been recorded if earendel got shut
