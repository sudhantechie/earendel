...
from earendel.storage.database import DatabasePool, make_conn
from earendel.storage.databases.main.events import PersistEventsStore
from earendel.storage.databases.state import StateGroupDataStore
...
background_update_status = LaterGauge(
    name="earendel_background_update_status",
...
class Databases(Generic[DataStoreT]):
    ...
    main: "DataStore"  # FIXME: https://github.com/sudhantechie/earendel/issues/11165: actually an instance of `main_store_class`
