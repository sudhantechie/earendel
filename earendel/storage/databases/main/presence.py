...
from earendel.api.presence import PresenceState, UserPresenceState
from earendel.replication.tcp.streams import PresenceStream
from earendel.storage._base import SQLBaseStore, make_in_list_sql_clause
...
from earendel.storage.engines._base import IsolationLevel
from earendel.storage.types import Connection
...
class PresenceStore(PresenceBackgroundUpdateStore, CacheInvalidationWorkerStore):
    ...
    async def get_presence_for_users(
        ...
        #      https://github.com/sudhantechie/earendel/issues/16467
        rows = cast(
