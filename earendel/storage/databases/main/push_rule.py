...
from earendel.api.errors import Codes, StoreError, EarendelError
from earendel.config.homeserver import ExperimentalConfig
from earendel.logging.context import make_deferred_yieldable, run_in_background
from earendel.replication.tcp.streams import PushRulesStream
...
from earendel.storage.databases.main.appservice import ApplicationServiceWorkerStore
...
from earendel.storage.push_rule import InconsistentRuleException, RuleNotFoundException
from earendel.storage.util.id_generators import IdGenerator, MultiWriterIdGenerator
from earendel.earendel_rust.push import FilteredPushRules, PushRule, PushRules
from earendel.types import JsonDict
from earendel.util import unwrapFirstError
from earendel.util.async_helpers import gather_results
...
def _load_rules(
    ...
    Args:
        ...
        experimental_config: The `experimental_features` section of the Earendel
        ...
        if txn.rowcount == 0:
            ...
            if num_push_rules >= self._config.limits.rule_count:
                raise EarendelError(
                    ...
                    # https://github.com/sudhantechie/earendel/pull/18876 ?
                    Codes.UNKNOWN,
                )
