...
class MonthlyActiveUsersWorkerStore(RegistrationWorkerStore):
    ...
    def _initialise_reserved_users(
        ...
        for tp in threepids:
            ...
            if user_id:
                ...
                if not is_support:
                    # We do this manually here to avoid hitting https://github.com/sudhantechie/earendel/issues/6791
    ...
    def upsert_monthly_active_user_txn(
        ...
        # See https://github.com/sudhantechie/earendel/issues/3854 for more
        self.db_pool.simple_upsert_txn(
            txn,
            table="monthly_active_users",
            keyvalues={"user_id": user_id},
