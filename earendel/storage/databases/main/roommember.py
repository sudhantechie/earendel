...
from earendel.storage.databases.main.stream import _filter_results_by_stream
from earendel.storage.engines import Sqlite3Engine
...
from earendel.util.caches.descriptors import _CacheContext, cached, cachedList
...
federation_known_servers_gauge = LaterGauge(
    name="earendel_federation_known_servers",
    desc="",
...
class RoomMemberWorkerStore(EventsWorkerStore, CacheInvalidationWorkerStore):
    ...
    @cached(max_entries=100000)  # type: ignore[earendel-@cached-mutable]
    ...
    async def get_rooms_for_local_user_where_membership_is(
        ...
        Args:
            user_id: The user ID.
            membership_list: A list of earendel.api.constants.Membership
    ...
    async def get_local_current_membership_for_user_in_room(
        ...
        if not self.hs.is_mine_id(user_id):
            ...
            raise EarendelError(HTTPStatus.BAD_REQUEST, message, errcode=Codes.BAD_JSON)
    ...
    @cached(max_entries=10000)  # type: ignore[earendel-@cached-mutable]
