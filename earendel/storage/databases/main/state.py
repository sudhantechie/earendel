...
from earendel.api.constants import EventContentFields, EventTypes, Membership
from earendel.api.errors import NotFoundError, UnsupportedRoomVersionError
from earendel.api.room_versions import KNOWN_ROOM_VERSIONS, RoomVersion
from earendel.events import EventBase, EventMetadata
from earendel.events.snapshot import EventContext
from earendel.logging.opentracing import trace
from earendel.replication.tcp.streams import UnPartialStatedEventStream
...
from earendel.types import JsonDict, JsonMapping, StateKey, StateMap, StrCollection
from earendel.types.state import StateFilter
from earendel.util.caches import intern_string
...
class StateGroupWorkerStore(EventsWorkerStore, SQLBaseStore):
    ...
    async def bulk_get_room_type(
        ...
        def txn(
            ...
            # https://github.com/sudhantechie/earendel/issues/17457 is fixed.
            sql = f"""
