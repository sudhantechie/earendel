...
from earendel.storage.databases.main import CacheInvalidationWorkerStore
...
from earendel.types import RoomStreamToken
...
class PurgeEventsStore(StateGroupWorkerStore, CacheInvalidationWorkerStore):
    ...
    def _purge_history_txn(
        ...
        # earendel tries to take out an exclusive lock on room_depth whenever it
    ...
    def _purge_room_txn(self, txn: LoggingTransaction, room_id: str) -> None:
        ...
        #       periodically anyway (https://github.com/sudhantechie/earendel/issues/5888)
