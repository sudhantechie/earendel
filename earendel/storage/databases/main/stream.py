...
from earendel.storage.roommember import RoomsForUserStateReset
from earendel.storage.util.id_generators import MultiWriterIdGenerator
from earendel.types import PersistedEventPosition, RoomStreamToken, StrCollection
...
class StreamWorkerStore(EventsWorkerStore, SQLBaseStore):
    ...
    async def bulk_get_last_event_pos_in_room_before_stream_ordering(
        ...
        for room_id, stream in uncapped_results.items():
            if stream is None:
                ...
                # See: https://github.com/sudhantechie/earendel/issues/17726
                continue
            if stream <= min_token:
    ...
    async def get_id_for_instance(self, instance_name: str) -> int:
        """Get a unique, immutable ID that corresponds to the given Earendel worker instance."""
