...
from earendel.push import PusherConfig, ThrottleParams
from earendel.replication.tcp.streams import PushersStream
...
class PusherWorkerStore(SQLBaseStore):
    ...
    async def _remove_deleted_email_pushers(
        ...
        In previous versions of earendel, when users deleted their email address, it didn't
