...
from earendel.logging.opentracing import log_kv
...
from earendel.types import MultiWriterStreamToken, RoomStreamToken
    ...
    async def get_latest_bump_stamp_for_room(
        ...
        return cast(
            ...
            await self.db_pool.simple_select_one_onecol(
                ...
                # by https://github.com/sudhantechie/earendel/issues/17623)
                #
