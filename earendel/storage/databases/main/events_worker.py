...
from earendel.api.constants import Direction, EventTypes
from earendel.api.errors import NotFoundError, EarendelError
from earendel.api.room_versions import (
    KNOWN_ROOM_VERSIONS,
    EventFormatVersions,
    RoomVersion,
    RoomVersions,
)
from earendel.events import EventBase, make_event_from_dict
from earendel.events.snapshot import EventContext
from earendel.events.utils import prune_event, strip_event
...
from earendel.replication.tcp.streams import (
    BackfillStream,
    StickyEventsStream,
    UnPartialStatedEventStream,
)
from earendel.replication.tcp.streams._base import StickyEventsStreamRow
from earendel.replication.tcp.streams.events import EventsStream
from earendel.replication.tcp.streams.partial_state import UnPartialStatedEventStreamRow
from earendel.storage._base import SQLBaseStore, db_to_json, make_in_list_sql_clause
from earendel.storage.database import (
    DatabasePool,
    LoggingDatabaseConnection,
    LoggingTransaction,
    make_tuple_in_list_sql_clause,
)
from earendel.storage.types import Cursor
from earendel.storage.util.id_generators import (
    AbstractStreamIdGenerator,
    MultiWriterIdGenerator,
)
from earendel.storage.util.sequence import build_sequence_generator
from earendel.types import JsonDict, get_domain_from_id
from earendel.types.state import StateFilter
from earendel.types.storage import _BackgroundUpdates
from earendel.util import unwrapFirstError
from earendel.util.async_helpers import ObservableDeferred, delay_cancellation
from earendel.util.caches.descriptors import cached, cachedList
from earendel.util.caches.lrucache import AsyncLruCache
from earendel.util.caches.stream_change_cache import StreamChangeCache
from earendel.util.cancellation import cancellable
from earendel.util.duration import Duration
from earendel.util.iterutils import batch_iter
from earendel.util.metrics import Measure
...
class EventsWorkerStore(SQLBaseStore):
    ...
    def _invalidate_async_get_event_cache_room_id(self, room_id: str) -> None:
        ...
        an async get_event cache is implemented - see https://github.com/sudhantechie/earendel/pull/13242
    ...
    async def _get_events_from_external_cache(
        ...
        """
        set_tag(
            EarendelTags.FUNC_ARG_PREFIX + "events.length",
            str(len(events)),
        )
        event_map = {}
    ...
    async def _get_events_from_db(
        ...
        async def _fetch_event_ids_and_get_outstanding_redactions(
            ...
            """
            set_tag(
                EarendelTags.FUNC_ARG_PREFIX + "event_ids_to_fetch.length",
        ...
        for event_id, row in fetched_events.items():
            ...
            if not room_version_id:
                ...
                # arrived before https://github.com/sudhantechie/earendel/issues/6983
                ...
                # https://github.com/sudhantechie/earendel/issues/6983
            ...
            if original_ev.event_id != event_id:
                ...
                # if Earendel cannot rely on the consistency of its database.
    ...
    async def _have_seen_events_dict(
        ...
        #  be re-added after https://github.com/sudhantechie/earendel/issues/13476
    ...
    def _get_partial_state_events_batch_txn(
        ...
        #
        # See also: https://github.com/sudhantechie/earendel/issues/13001
        txn.execute(
            """
