...
from earendel.storage._base import make_in_list_sql_clause
...
from earendel.storage.engines import BaseDatabaseEngine
from earendel.storage.types import Cursor
from earendel.types import get_domain_from_id
...
def check_database_before_upgrade(
    ...
    raise Exception(
        ...
        "You cannot change a earendel server_name after it's been configured"
