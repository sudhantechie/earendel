...
from earendel.api.constants import MAIN_TIMELINE, Direction, RelationTypes
...
from earendel.storage.databases.main.stream import (
    generate_next_token,
    generate_pagination_bounds,
    generate_pagination_where_clause,
)
from earendel.storage.engines import PostgresEngine
from earendel.types import JsonDict, StreamKeyType, StreamToken
...
class ThreadsNextBatch:
    ...
    def from_string(cls, string: str) -> "ThreadsNextBatch":
        ...
        try:
            ...
            raise EarendelError(400, "Invalid threads token")
...
class RelationsWorkerStore(SQLBaseStore):
    ...
    @cached()  # type: ignore[earendel-@cached-mutable]
    ...
    @cachedList(cached_method_name="get_applicable_edit", list_name="event_ids")  # type: ignore[earendel-@cached-mutable]
    ...
    # TODO: This returns a mutable object, which is generally bad.
    @cachedList(cached_method_name="get_thread_summary", list_name="event_ids")  # type: ignore[earendel-@cached-mutable]
