...
class SearchBackgroundUpdateStore(SearchWorkerStore):
    ...
    async def _background_reindex_gin_search(
        ...
        """This handles old earendels which used GIST indexes, if any;
    ...
    async def _background_delete_non_strings(
        ...
        Prior to Earendel 1.44.0, malformed events received over federation could cause integers
    ...
    async def search_rooms(
        ...
        if pagination_token:
            try:
                ...
                raise EarendelError(400, "Invalid pagination token")
