...
from earendel.api.errors import PartialStateConflictError
from earendel.api.room_versions import RoomVersions
from earendel.events import (
    EventBase,
    StrippedStateEvent,
...
from earendel.events.py_protocol import MSC4242Event, supports_msc4242_state_dag
from earendel.events.snapshot import EventPersistencePair
from earendel.events.utils import parse_stripped_state_event
from earendel.logging.opentracing import trace
from earendel.metrics import SERVER_NAME_LABEL
from earendel.storage._base import db_to_json, make_in_list_sql_clause
...
from earendel.storage.databases.main.event_federation import EventFederationStore
from earendel.storage.databases.main.events_worker import EventCacheEntry
from earendel.storage.databases.main.search import SearchEntry
from earendel.storage.engines import PostgresEngine
from earendel.storage.util.id_generators import AbstractStreamIdGenerator
from earendel.storage.util.sequence import SequenceGenerator
...
from earendel.util.events import get_plain_text_topic_from_event_content
from earendel.util.iterutils import batch_iter, sorted_topologically
from earendel.util.json import json_encoder
from earendel.util.stringutils import non_null_str_or_none
...
persist_event_counter = Counter(
    "earendel_storage_events_persisted_events", "", labelnames=[SERVER_NAME_LABEL]
)
event_counter = Counter(
    "earendel_storage_events_persisted_events_sep",
    "",
    labelnames=[
...
class PersistEventsStore:
        ...
        *,
        ...
        async with stream_ordering_manager as stream_orderings:
            ...
            if not use_negative_stream_ordering:
                ...
                # stream_ordering.
                earendel.metrics.event_persisted_position.labels(
    ...
    def _persist_transaction_ids_txn(
        ...
        # Earendel relies on the device_id to scope transactions for events..
    ...
    def _update_current_state_txn(
            ...
            txn.execute_batch(
                ...
                [
                    [
                        ...
                        # matches how Earendel currently thinks about the forgotten status)
                        0,
        ...
        if self._include_profile_updates_in_sync:
            ...
            # edge cases.
            # FIXME: See issue https://github.com/sudhantechie/earendel/issues/19981
            ...
            if profile_update_additions:
                ...
                # See https://github.com/sudhantechie/earendel/issues/19981
