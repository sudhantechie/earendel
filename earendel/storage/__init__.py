...
"""
The storage layer is split up into multiple parts to allow Earendel to run
...
`earendel.storage.controllers` module. These classes provide high level
...
stored in `earendel.storage.schema`.
"""
