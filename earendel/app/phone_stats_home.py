...
"""
We recalculate earendel_non_deactivated_user_count every 5 minutes, which allows
...
current_mau_gauge = Gauge(
    "earendel_admin_mau_current",
    "Current MAU",
    labelnames=[SERVER_NAME_LABEL],
)
current_mau_by_service_gauge = Gauge(
    "earendel_admin_mau_current_mau_by_service",
    "Current MAU by service",
    labelnames=["app_service", SERVER_NAME_LABEL],
)
max_mau_gauge = Gauge(
    "earendel_admin_mau_max",
    "MAU Limit",
    labelnames=[SERVER_NAME_LABEL],
)
registered_reserved_users_mau_gauge = Gauge(
    "earendel_admin_mau_registered_reserved_users",
    "Registered users with reserved threepids",
    labelnames=[SERVER_NAME_LABEL],
)
user_count_gauge = Gauge(
    "earendel_non_deactivated_user_count",
    "Total non-deactivated user count within the Earendel database, split by appservice",
    labelnames=["app_service", SERVER_NAME_LABEL],
)
...
def phone_stats_home(
    ...
    async def _phone_stats_home(
        ...
        #
        earendel_logger = logging.getLogger("earendel")
        log_level = earendel_logger.getEffectiveLevel()
