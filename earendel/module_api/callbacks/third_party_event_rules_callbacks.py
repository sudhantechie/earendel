...
from earendel.api.errors import ModuleFailedException, EarendelError
from earendel.events import EventBase
from earendel.events.snapshot import UnpersistedEventContextBase
from earendel.storage.roommember import ProfileInfo
from earendel.types import Requester, StateMap
    ...
    async def check_event_allowed(
        ...
        for callback in self._check_event_allowed_callbacks:
            try:
                ...
                # FIXME: Being able to throw EarendelErrors is relied upon by
                # some modules. PR https://github.com/sudhantechie/earendel/pull/10386
    ...
    async def on_create_room(
        ...
        for callback in self._on_create_room_callbacks:
            try:
                ...
                # it's a EarendelError we can send to clients.
                if not isinstance(e, EarendelError):
                    e = EarendelError(
