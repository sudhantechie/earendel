...
_background_process_ru_utime = Counter(
    "earendel_background_process_ru_utime_seconds",
...
_background_process_ru_stime = Counter(
    "earendel_background_process_ru_stime_seconds",
...
_background_process_db_txn_count = Counter(
    "earendel_background_process_db_txn_count",
...
_background_process_db_txn_duration = Counter(
    "earendel_background_process_db_txn_duration_seconds",
    (
...
_background_process_db_sched_duration = Counter(
    "earendel_background_process_db_sched_duration_seconds",
...
class _BackgroundProcess:
    ...
    def update_metrics(self) -> None:
        ...
        # earendel.http.request_metrics.RequestMetrics.update_metrics.
                ...
                if bg_start_span:
                    ...
                    if original_active_tracing_span is not None:
                        ...
                        root_tracing_scope = start_active_span(
                            f"bgproc.{desc}",
                            tags={EarendelTags.REQUEST_ID: str(logging_context)},
