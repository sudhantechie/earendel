...
from earendel.api.auth import Auth
from earendel.api.auth.internal import InternalAuth
from earendel.api.auth.mas import MasDelegatedAuth
from earendel.api.auth_blocking import AuthBlocking
from earendel.api.errors import HomeServerNotSetupException
from earendel.api.filtering import Filtering
from earendel.api.ratelimiting import Ratelimiter, RequestRatelimiter
from earendel.app._base import unregister_sighups
from earendel.app.phone_stats_home import start_phone_stats_home
from earendel.appservice.api import ApplicationServiceApi
from earendel.appservice.scheduler import ApplicationServiceScheduler
from earendel.config.homeserver import HomeServerConfig
from earendel.crypto import context_factory
from earendel.crypto.context_factory import RegularPolicyForHTTPS
from earendel.crypto.keyring import Keyring
from earendel.events.builder import EventBuilderFactory
from earendel.events.presence_router import PresenceRouter
from earendel.events.utils import EventClientSerializer
from earendel.federation.federation_client import FederationClient
from earendel.federation.federation_server import (
    FederationHandlerRegistry,
    FederationServer,
)
from earendel.federation.send_queue import FederationRemoteSendQueue
from earendel.federation.sender import AbstractFederationSender, FederationSender
from earendel.federation.transport.client import TransportLayerClient
from earendel.handlers.account import AccountHandler
from earendel.handlers.account_data import AccountDataHandler
from earendel.handlers.account_validity import AccountValidityHandler
from earendel.handlers.admin import AdminHandler
from earendel.handlers.appservice import ApplicationServicesHandler
from earendel.handlers.auth import AuthHandler, PasswordAuthProvider
from earendel.handlers.cas import CasHandler
from earendel.handlers.deactivate_account import DeactivateAccountHandler
from earendel.handlers.delayed_events import DelayedEventsHandler
from earendel.handlers.device import DeviceHandler, DeviceWriterHandler
from earendel.handlers.devicemessage import DeviceMessageHandler
from earendel.handlers.directory import DirectoryHandler
from earendel.handlers.e2e_keys import E2eKeysHandler
from earendel.handlers.e2e_room_keys import E2eRoomKeysHandler
from earendel.handlers.event_auth import EventAuthHandler
from earendel.handlers.events import EventHandler, EventStreamHandler
from earendel.handlers.federation import FederationHandler
from earendel.handlers.federation_event import FederationEventHandler
from earendel.handlers.identity import IdentityHandler
from earendel.handlers.initial_sync import InitialSyncHandler
from earendel.handlers.message import EventCreationHandler, MessageHandler
from earendel.handlers.pagination import PaginationHandler
from earendel.handlers.password_policy import PasswordPolicyHandler
from earendel.handlers.presence import (
    BasePresenceHandler,
    PresenceHandler,
    WorkerPresenceHandler,
)
from earendel.handlers.profile import ProfileHandler
from earendel.handlers.push_rules import PushRulesHandler
from earendel.handlers.read_marker import ReadMarkerHandler
from earendel.handlers.receipts import ReceiptsHandler
from earendel.handlers.register import RegistrationHandler
from earendel.handlers.relations import RelationsHandler
from earendel.handlers.reports import ReportsHandler
from earendel.handlers.room import (
    RoomContextHandler,
    RoomCreationHandler,
    RoomShutdownHandler,
    TimestampLookupHandler,
)
from earendel.handlers.room_list import RoomListHandler
from earendel.handlers.room_member import (
    RoomForgetterHandler,
    RoomMemberHandler,
    RoomMemberMasterHandler,
)
from earendel.handlers.room_member_worker import RoomMemberWorkerHandler
from earendel.handlers.room_policy import RoomPolicyHandler
from earendel.handlers.room_summary import RoomSummaryHandler
from earendel.handlers.search import SearchHandler
from earendel.handlers.send_email import SendEmailHandler
from earendel.handlers.set_password import SetPasswordHandler
from earendel.handlers.sliding_sync import SlidingSyncHandler
from earendel.handlers.sso import SsoHandler
from earendel.handlers.stats import StatsHandler
from earendel.handlers.sync import SyncHandler
from earendel.handlers.thread_subscriptions import ThreadSubscriptionsHandler
from earendel.handlers.typing import FollowerTypingHandler, TypingWriterHandler
from earendel.handlers.user_directory import UserDirectoryHandler
from earendel.handlers.worker_lock import WorkerLocksHandler
from earendel.http.client import (
    InsecureInterceptableContextFactory,
    ReplicationClient,
    SimpleHttpClient,
)
from earendel.http.matrixfederationclient import MatrixFederationHttpClient
from earendel.logging.context import PreserveLoggingContext
from earendel.media.media_repository import MediaRepository
from earendel.metrics import (
    SERVER_NAME_LABEL,
    all_later_gauges_to_clean_up_on_shutdown,
    register_threadpool,
    earendel_server_name_info,
)
from earendel.metrics.background_process_metrics import run_as_background_process
from earendel.metrics.common_usage_metrics import CommonUsageMetricsManager
from earendel.module_api import ModuleApi
from earendel.module_api.callbacks import ModuleApiCallbacks
from earendel.notifier import Notifier, ReplicationNotifier
from earendel.push.bulk_push_rule_evaluator import BulkPushRuleEvaluator
from earendel.push.pusherpool import PusherPool
from earendel.replication.tcp.client import ReplicationDataHandler
from earendel.replication.tcp.external_cache import ExternalCache
from earendel.replication.tcp.handler import ReplicationCommandHandler
from earendel.replication.tcp.resource import ReplicationStreamer
from earendel.replication.tcp.streams import STREAMS_MAP, Stream
from earendel.rest.media.media_repository_resource import MediaRepositoryResource
from earendel.server_notices.server_notices_manager import ServerNoticesManager
from earendel.server_notices.server_notices_sender import ServerNoticesSender
from earendel.server_notices.worker_server_notices_sender import (
    WorkerServerNoticesSender,
)
from earendel.state import StateHandler, StateResolutionHandler
from earendel.storage import Databases
from earendel.storage.controllers import StorageControllers
from earendel.streams.events import EventSources
from earendel.earendel_rust.handlers import RustHandlers
from earendel.earendel_rust.msc4388_rendezvous import MSC4388RendezvousHandler
from earendel.earendel_rust.rendezvous import RendezvousHandler
from earendel.types import DomainSpecificString, IEarendelReactor
from earendel.util import EAREENDEL_VERSION
from earendel.util.caches import CACHE_METRIC_REGISTRY
from earendel.util.clock import Clock
from earendel.util.distributor import Distributor
from earendel.util.macaroons import MacaroonGenerator
from earendel.util.ratelimitutils import FederationRateLimiter
from earendel.util.stringutils import random_string
from earendel.util.task_scheduler import TaskScheduler
...
if TYPE_CHECKING:
    ...
    from earendel.handlers.jwt import JwtHandler
    from earendel.handlers.oidc import OidcHandler
    from earendel.handlers.saml import SamlHandler
    from earendel.storage._base import SQLBaseStore
...
class HomeServer(metaclass=abc.ABCMeta):
    ...
    Attributes:
        config (earendel.config.homeserver.HomeserverConfig):
    ...
    def DATASTORE_CLASS(self) -> type["SQLBaseStore"]:
        ...
        # (such as earendel.app.homeserver.EarendelHomeServer) and gives the class to be
    ...
    def __init__(
        ...
        reactor: Optional[IEarendelReactor] = None,
    ):
        """
        Args:
        ...
        if not reactor:
            ...
            reactor = cast(IEarendelReactor, _reactor)
        ...
        self.version_string = f"Earendel/{EAREENDEL_VERSION}"
        ...
        earendel_server_name_info.labels(**{SERVER_NAME_LABEL: self.hostname}).set(1)
    ...
    def run_as_background_process(
        ...
        **kwargs: Any,
        ...
        follow the earendel logcontext rules, which makes it appropriate for passing to
        clock.looping_call and friends (or for firing-and-forgetting in the middle of a
        normal earendel async function).

        Because the returned Deferred does not follow the earendel logcontext rules, awaiting
        ...
        Returns:
            ...
            Note that the returned Deferred does not follow the earendel logcontext
            rules.
        """
    ...
    async def shutdown(self) -> None:
        ...
        in order for it to be cleaned up. By default, Earendel freezes the HomeServer
    ...
    def register_module_web_resource(self, path: str, resource: Resource) -> None:
        ...
        Raises:
            EarendelError(500): A module tried to register a web resource after the HTTP
    ...
    def get_instance_id(self) -> str:
        """A unique ID for this earendel process instance.
    ...
    def get_instance_name(self) -> str:
        """A unique name for this earendel process.
    ...
    def get_reactor(self) -> IEarendelReactor:
        """
    ...
    def get_outbound_redis_connection(self) -> "ConnectionHandler":
        ...
        from earendel.replication.tcp.redis import lazyConnection, lazyUnixConnection
