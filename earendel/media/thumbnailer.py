...
from earendel.api.errors import Codes, NotFoundError, EarendelError, cs_error
from earendel.config.repository import THUMBNAIL_SUPPORTED_MEDIA_FORMAT_MAP
...
from earendel.media.media_storage import FileResponder, MediaStorage
from earendel.storage.databases.main.media_repository import LocalMedia
...
class ThumbnailProvider:
    ...
    async def select_or_generate_local_thumbnail(
        ...
        if thumbnail_result:
            ...
            raise EarendelError(400, "Failed to generate thumbnail.")
    ...
    async def _select_and_respond_with_thumbnail(
        ...
        # If `dynamic_thumbnails` is enabled, we expect Earendel to go down a
