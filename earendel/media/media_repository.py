...
from earendel.config.repository import ThumbnailRequirement
from earendel.http.server import respond_with_json
...
from earendel.media._base import (
    FileInfo,
    Responder,
    ThumbnailInfo,
...
from earendel.media.filepath import MediaFilePaths
from earendel.media.media_storage import (
    MediaStorage,
    SHA256TransparentIOReader,
    SHA256TransparentIOWriter,
)
from earendel.media.storage_provider import (
    FileStorageProviderBackend,
    StorageProviderWrapper,
)
from earendel.media.thumbnailer import (
    ANIMATED_THUMBNAIL_TYPE,
    Thumbnailer,
    ThumbnailError,
)
from earendel.media.url_previewer import UrlPreviewer
from earendel.storage.databases.main.media_repository import LocalMedia, RemoteMedia
from earendel.types import UserID
...
class MediaRepository:
    ...
    async def create_or_update_content(
        ...
        for limit in media_upload_limits:
            ...
            if uploaded_media_size + content_length > limit.max_bytes:
                ...
                # Fall back to the static page served by Earendel when the limit
    ...
    def respond_not_yet_uploaded(self, request: EarendelRequest) -> None:
        respond_with_json(
            request,
            504,
        ...
        try:
            ...
            if isinstance(e, self.store.database_engine.module.IntegrityError):
                ...
                if not media_info:
                    ...
                    raise EarendelError(500, "Failed to fetch remote media")
            else:
                raise e
    ...
    async def _download_remote_file(
        ...
        async with self.media_storage.store_into_file(file_info) as (f, fname):
            ...
            try:
                ...
                raise EarendelError(502, "Failed to fetch remote media")
