...
pub mod unsigned_field {
    ...
    /// Unsigned field: io.element.earendel.soft_failed (admin metadata)
    pub const SOFT_FAILED: &str = "io.element.earendel.soft_failed";
    /// Unsigned field: io.element.earendel.policy_server_spammy (admin metadata)
    pub const POLICY_SERVER_SPAMMY: &str = "io.element.earendel.policy_server_spammy";
