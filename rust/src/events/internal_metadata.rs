...
impl EventInternalMetadataInner {
    ...
    ///
    /// See also
    /// https://github.com/sudhantechie/earendel/develop/development/room-dag-concepts.html#out-of-band-membership-events.
    ///
    /// (Added in earendel 0.99.0, so may be unreliable for events received
    /// before that)
