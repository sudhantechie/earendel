...
use crate::{
    ...
    errors::{NotFoundError, EarendelError},
...
impl RendezvousHandler {
    ...
    fn new(
        ...
        let eviction_duration = EarendelDuration::from_milliseconds(eviction_interval);
    ...
    fn handle_put(
        ...
        *response.status_mut() = StatusCode::ACCEPTED;
        ...
        // Specifically, we noticed this behaviour when placing Earendel behind Cloudflare.
...
pub fn register_module(py: Python<'_>, m: &Bound<'_, PyModule>) -> PyResult<()> {
    ...
    // earendel.earendel_rust import rendezvous` work.
    py.import("sys")?
        .getattr("modules")?
        .set_item("earendel.earendel_rust.rendezvous", child_module)?;
